...
Namespace DS12188
	...
	Partial Public Class CarsDBLabelDataSet
		...
		Public Overrides Function Clone() As Global.System.Data.DataSet
			Dim cln As CarsDBLabelDataSet = (CType(MyBase.Clone(), CarsDBLabelDataSet))
			cln.InitVars()
		...
		Private Sub InitClass()
			Me.DataSetName = "CarsDBLabelDataSet"
			Me.Prefix = ""
			Me.Namespace = "http://tempuri.org/CarsDBLabelDataSet.xsd"
		...
		Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
			Dim ds As New CarsDBLabelDataSet()
		...
		Partial Public Class CarsDataTable
			...
			Private columnResourceNumber As Global.System.Data.DataColumn
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute()> _
			Public ReadOnly Property ResourceNumberColumn() As Global.System.Data.DataColumn
				Get
					Return Me.columnResourceNumber
				End Get
			End Property
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute()> _
			Public Function AddCarsRow(ByVal ResourceNumber As Integer, ByVal Trademark As String, ByVal Model As String, ByVal HP As Short, ByVal Liter As Double, ByVal Cyl As Byte, ByVal TransmissSpeedCount As Byte, ByVal TransmissAutomatic As String, ByVal MPG_City As Byte, ByVal MPG_Highway As Byte, ByVal Category As String, ByVal Description As String, ByVal Hyperlink As String, ByVal Picture() As Byte, ByVal Price As Decimal, ByVal RtfContent As String, ByVal Color As Integer) As CarsRow
				Dim rowCarsRow As CarsRow = (CType(Me.NewRow(), CarsRow))
				Dim columnValuesArray() As Object = { ResourceNumber, Nothing, Trademark, Model, HP, Liter, Cyl, TransmissSpeedCount, TransmissAutomatic, MPG_City, MPG_Highway, Category, Description, Hyperlink, Picture, Price, RtfContent, Color}
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute()> _
			Friend Sub InitVars()
				Me.columnResourceNumber = MyBase.Columns("ResourceNumber")
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute()> _
			Private Sub InitClass()
				Me.columnResourceNumber = New Global.System.Data.DataColumn("ResourceNumber", GetType(Integer), Nothing, Global.System.Data.MappingType.Element)
				MyBase.Columns.Add(Me.columnResourceNumber)
		...
		Partial Public Class CarSchedulingDataTable
			...
			Public Function AddCarSchedulingRow(ByVal parentCarsRowByCarsCarScheduling As CarsRow, ByVal UserId As Integer, ByVal Status As Integer, ByVal Subject As String, ByVal Description As String, ByVal Label As Integer, ByVal StartTime As System.DateTime, ByVal EndTime As System.DateTime, ByVal Location As String, ByVal AllDay As Boolean, ByVal EventType As Integer, ByVal RecurrenceInfo As String, ByVal ReminderInfo As String, ByVal Price As Decimal, ByVal ContactInfo As String) As CarSchedulingRow
				...
				If (parentCarsRowByCarsCarScheduling IsNot Nothing) Then
					columnValuesArray(1) = parentCarsRowByCarsCarScheduling(1)
				End If
		...
		Partial Public Class CarsRow
			...
			Public Property ResourceNumber() As Integer
				Get
					Try
						Return (CInt(Fix(Me(Me.tableCars.ResourceNumberColumn))))
					Catch e As Global.System.InvalidCastException
						Throw New Global.System.Data.StrongTypingException("The value for column 'ResourceNumber' in table 'Cars' is DBNull.", e)
					End Try
				End Get
				Set(ByVal value As Integer)
					Me(Me.tableCars.ResourceNumberColumn) = value
				End Set
			End Property
			...
			Public Property Color() As Integer
				Get
					Try
						Return (CInt(Fix(Me(Me.tableCars.ColorColumn))))
					Catch e As Global.System.InvalidCastException
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute()> _
			Public Function IsResourceNumberNull() As Boolean
				Return Me.IsNull(Me.tableCars.ResourceNumberColumn)
			End Function

			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute()> _
			Public Sub SetResourceNumberNull()
				Me(Me.tableCars.ResourceNumberColumn) = Global.System.Convert.DBNull
			End Sub
	...
	End Class
End Namespace
Namespace DS12188.CarsDBLabelDataSetTableAdapters
	...
	Partial Public Class CarsTableAdapter
		...
		Private Sub InitAdapter()
			...
			tableMapping.ColumnMappings.Add("ResourceNumber", "ResourceNumber")
			...
			Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Cars` WHERE (((? = 1 AND `ResourceNumber` IS NULL) OR (`ResourceNumber` = ?)) AND (`ID` = ?) AND ((? = 1 AND `Trademark` IS NULL) OR (`Trademark` = ?)) AND ((? = 1 AND `Model` IS NULL) OR (`Model` = ?)) AND ((? = 1 AND `HP` IS NULL) OR (`HP` = ?)) AND ((? = 1 AND `Liter` IS NULL) OR (`Liter` = ?)) AND ((? = 1 AND `Cyl` IS NULL) OR (`Cyl` = ?)) AND ((? = 1 AND `TransmissSpeedCount` IS NULL) OR (`TransmissSpeedCount` = ?)) AND ((? = 1 AND `TransmissAutomatic` IS NULL) OR (`TransmissAutomatic` = ?)) AND ((? = 1 AND `MPG_City` IS NULL) OR (`MPG_City` = ?)) AND ((? = 1 AND `MPG_Highway` IS NULL) OR (`MPG_Highway` = ?)) AND ((? = 1 AND `Category` IS NULL) OR (`Category` = ?)) AND ((? = 1 AND `Hyperlink` IS NULL) OR (`Hyperlink` = ?)) AND ((? = 1 AND `Price` IS NULL) OR (`Price` = ?)) AND ((? = 1 AND `Color` IS NULL) OR (`Color` = ?)))"
			Me._adapter.DeleteCommand.CommandType = Global.System.Data.CommandType.Text
			Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("IsNull_ResourceNumber", Global.System.Data.OleDb.OleDbType.Integer, 0, Global.System.Data.ParameterDirection.Input, (CByte(0)), (CByte(0)), "ResourceNumber", Global.System.Data.DataRowVersion.Original, True, Nothing))
			Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Original_ResourceNumber", Global.System.Data.OleDb.OleDbType.Integer, 0, Global.System.Data.ParameterDirection.Input, (CByte(0)), (CByte(0)), "ResourceNumber", Global.System.Data.DataRowVersion.Original, False, Nothing))
			...
			Me._adapter.InsertCommand.CommandText = "INSERT INTO `Cars` (`ResourceNumber`, `Trademark`, `Model`, `HP`, `Liter`, `Cyl`, `TransmissSpeedCount`, `TransmissAutomatic`, `MPG_City`, `MPG_Highway`, `Category`, `Description`, `Hyperlink`, `Picture`, `Price`, `RtfContent`, `Color`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)"
			Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
			Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("ResourceNumber", Global.System.Data.OleDb.OleDbType.Integer, 0, Global.System.Data.ParameterDirection.Input, (CByte(0)), (CByte(0)), "ResourceNumber", Global.System.Data.DataRowVersion.Current, False, Nothing))
			...
			Me._adapter.UpdateCommand.CommandText = "UPDATE `Cars` SET `ResourceNumber` = ?, `Trademark` = ?, `Model` = ?, `HP` = ?, `Liter` = ?, `Cyl` = ?, `TransmissSpeedCount` = ?, `TransmissAutomatic` = ?, `MPG_City` = ?, `MPG_Highway` = ?, `Category` = ?, `Description` = ?, `Hyperlink` = ?, `Picture` = ?, `Price` = ?, `RtfContent` = ?, `Color` = ? WHERE (((? = 1 AND `ResourceNumber` IS NULL) OR (`ResourceNumber` = ?)) AND (`ID` = ?) AND ((? = 1 AND `Trademark` IS NULL) OR (`Trademark` = ?)) AND ((? = 1 AND `Model` IS NULL) OR (`Model` = ?)) AND ((? = 1 AND `HP` IS NULL) OR (`HP` = ?)) AND ((? = 1 AND `Liter` IS NULL) OR (`Liter` = ?)) AND ((? = 1 AND `Cyl` IS NULL) OR (`Cyl` = ?)) AND ((? = 1 AND `TransmissSpeedCount` IS NULL) OR (`TransmissSpeedCount` = ?)) AND ((? = 1 AND `TransmissAutomatic` IS NULL) OR (`TransmissAutomatic` = ?)) AND ((? = 1 AND `MPG_City` IS NULL) OR (`MPG_City` = ?)) AND ((? = 1 AND `MPG_Highway` IS NULL) OR (`MPG_Highway` = ?)) AND ((? = 1 AND `Category` IS NULL) OR (`Category` = ?)) AND ((? = 1 AND `Hyperlink` IS NULL) OR (`Hyperlink` = ?)) AND ((? = 1 AND `Price` IS NULL) OR (`Price` = ?)) AND ((? = 1 AND `Color` IS NULL) OR (`Color` = ?)))"
			Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
			Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("ResourceNumber", Global.System.Data.OleDb.OleDbType.Integer, 0, Global.System.Data.ParameterDirection.Input, (CByte(0)), (CByte(0)), "ResourceNumber", Global.System.Data.DataRowVersion.Current, False, Nothing))
			...
			Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("IsNull_ResourceNumber", Global.System.Data.OleDb.OleDbType.Integer, 0, Global.System.Data.ParameterDirection.Input, (CByte(0)), (CByte(0)), "ResourceNumber", Global.System.Data.DataRowVersion.Original, True, Nothing))
			Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Original_ResourceNumber", Global.System.Data.OleDb.OleDbType.Integer, 0, Global.System.Data.ParameterDirection.Input, (CByte(0)), (CByte(0)), "ResourceNumber", Global.System.Data.DataRowVersion.Original, False, Nothing))
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0).CommandText = "SELECT ResourceNumber, ID, Trademark, Model, HP, Liter, Cyl, TransmissSpeedCount," & " TransmissAutomatic, MPG_City, MPG_Highway, Category, Description, Hyperlink, Pi" & "cture, Price, RtfContent, Color FROM Cars"
		...
		Public Overridable Function Fill(ByVal dataTable As CarsDBLabelDataSet.CarsDataTable) As Integer
		...
		Public Overridable Function GetData() As CarsDBLabelDataSet.CarsDataTable
			Me.Adapter.SelectCommand = Me.CommandCollection(0)
			Dim dataTable As New CarsDBLabelDataSet.CarsDataTable()
		...
		Public Overridable Function Update(ByVal dataTable As CarsDBLabelDataSet.CarsDataTable) As Integer
			Return Me.Adapter.Update(dataTable)
		End Function

		<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")> _
		Public Overridable Function Update(ByVal dataSet As CarsDBLabelDataSet) As Integer
		...
		Public Overridable Function Delete(ByVal Original_ResourceNumber As Global.System.Nullable(Of Integer), ByVal Original_ID As Integer, ByVal Original_Trademark As String, ByVal Original_Model As String, ByVal Original_HP As Global.System.Nullable(Of Short), ByVal Original_Liter As Global.System.Nullable(Of Double), ByVal Original_Cyl As Global.System.Nullable(Of Byte), ByVal Original_TransmissSpeedCount As Global.System.Nullable(Of Byte), ByVal Original_TransmissAutomatic As String, ByVal Original_MPG_City As Global.System.Nullable(Of Byte), ByVal Original_MPG_Highway As Global.System.Nullable(Of Byte), ByVal Original_Category As String, ByVal Original_Hyperlink As String, ByVal Original_Price As Global.System.Nullable(Of Decimal), ByVal Original_Color As Global.System.Nullable(Of Integer)) As Integer
			If (Original_ResourceNumber.HasValue = True) Then
				Me.Adapter.DeleteCommand.Parameters(0).Value = (CObj(0))
				Me.Adapter.DeleteCommand.Parameters(1).Value = (CInt(Fix(Original_ResourceNumber.Value)))
			Else
				Me.Adapter.DeleteCommand.Parameters(0).Value = (CObj(1))
				Me.Adapter.DeleteCommand.Parameters(1).Value = Global.System.DBNull.Value
			End If
			Me.Adapter.DeleteCommand.Parameters(2).Value = (CInt(Fix(Original_ID)))
			...
			Else
				...
				Me.Adapter.DeleteCommand.Parameters(4).Value = (CStr(Original_Trademark))
			End If
			...
			Else
				...
				Me.Adapter.DeleteCommand.Parameters(6).Value = (CStr(Original_Model))
			End If
			If (Original_HP.HasValue = True) Then
				Me.Adapter.DeleteCommand.Parameters(7).Value = (CObj(0))
				Me.Adapter.DeleteCommand.Parameters(8).Value = (CShort(Fix(Original_HP.Value)))
			Else
			...
			If (Original_Liter.HasValue = True) Then
				...
				Me.Adapter.DeleteCommand.Parameters(10).Value = (CDbl(Original_Liter.Value))
			Else
			...
			If (Original_Cyl.HasValue = True) Then
				...
				Me.Adapter.DeleteCommand.Parameters(12).Value = (CByte(Original_Cyl.Value))
			Else
			...
			If (Original_TransmissSpeedCount.HasValue = True) Then
				...
				Me.Adapter.DeleteCommand.Parameters(14).Value = (CByte(Original_TransmissSpeedCount.Value))
			Else
			...
			Else
				...
				Me.Adapter.DeleteCommand.Parameters(16).Value = (CStr(Original_TransmissAutomatic))
			End If
			If (Original_MPG_City.HasValue = True) Then
				Me.Adapter.DeleteCommand.Parameters(17).Value = (CObj(0))
				Me.Adapter.DeleteCommand.Parameters(18).Value = (CByte(Original_MPG_City.Value))
			Else
			...
			If (Original_MPG_Highway.HasValue = True) Then
				...
				Me.Adapter.DeleteCommand.Parameters(20).Value = (CByte(Original_MPG_Highway.Value))
			Else
			...
			Else
				...
				Me.Adapter.DeleteCommand.Parameters(22).Value = (CStr(Original_Category))
			End If
			...
			Else
				...
				Me.Adapter.DeleteCommand.Parameters(24).Value = (CStr(Original_Hyperlink))
			End If
			If (Original_Price.HasValue = True) Then
				Me.Adapter.DeleteCommand.Parameters(25).Value = (CObj(0))
				Me.Adapter.DeleteCommand.Parameters(26).Value = (CDec(Original_Price.Value))
			Else
			...
			If (Original_Color.HasValue = True) Then
				...
				Me.Adapter.DeleteCommand.Parameters(28).Value = (CInt(Fix(Original_Color.Value)))
			Else
		...
		Public Overridable Function Insert(ByVal ResourceNumber As Global.System.Nullable(Of Integer), ByVal Trademark As String, ByVal Model As String, ByVal HP As Global.System.Nullable(Of Short), ByVal Liter As Global.System.Nullable(Of Double), ByVal Cyl As Global.System.Nullable(Of Byte), ByVal TransmissSpeedCount As Global.System.Nullable(Of Byte), ByVal TransmissAutomatic As String, ByVal MPG_City As Global.System.Nullable(Of Byte), ByVal MPG_Highway As Global.System.Nullable(Of Byte), ByVal Category As String, ByVal Description As String, ByVal Hyperlink As String, ByVal Picture() As Byte, ByVal Price As Global.System.Nullable(Of Decimal), ByVal RtfContent As String, ByVal Color As Global.System.Nullable(Of Integer)) As Integer
			If (ResourceNumber.HasValue = True) Then
				Me.Adapter.InsertCommand.Parameters(0).Value = (CInt(Fix(ResourceNumber.Value)))
			Else
			...
			Else
				Me.Adapter.InsertCommand.Parameters(1).Value = (CStr(Trademark))
			End If
			If (Model Is Nothing) Then
				Me.Adapter.InsertCommand.Parameters(2).Value = Global.System.DBNull.Value
			Else
				Me.Adapter.InsertCommand.Parameters(2).Value = (CStr(Model))
			End If
			If (HP.HasValue = True) Then
				Me.Adapter.InsertCommand.Parameters(3).Value = (CShort(Fix(HP.Value)))
			Else
				Me.Adapter.InsertCommand.Parameters(3).Value = Global.System.DBNull.Value
			End If
			If (Liter.HasValue = True) Then
				Me.Adapter.InsertCommand.Parameters(4).Value = (CDbl(Liter.Value))
			Else
				Me.Adapter.InsertCommand.Parameters(4).Value = Global.System.DBNull.Value
			End If
			If (Cyl.HasValue = True) Then
				Me.Adapter.InsertCommand.Parameters(5).Value = (CByte(Cyl.Value))
			Else
				Me.Adapter.InsertCommand.Parameters(5).Value = Global.System.DBNull.Value
			End If
			If (TransmissSpeedCount.HasValue = True) Then
				Me.Adapter.InsertCommand.Parameters(6).Value = (CByte(TransmissSpeedCount.Value))
			Else
			...
			Else
				Me.Adapter.InsertCommand.Parameters(7).Value = (CStr(TransmissAutomatic))
			End If
			If (MPG_City.HasValue = True) Then
				Me.Adapter.InsertCommand.Parameters(8).Value = (CByte(MPG_City.Value))
			Else
				Me.Adapter.InsertCommand.Parameters(8).Value = Global.System.DBNull.Value
			End If
			If (MPG_Highway.HasValue = True) Then
				Me.Adapter.InsertCommand.Parameters(9).Value = (CByte(MPG_Highway.Value))
			Else
			...
			Else
				Me.Adapter.InsertCommand.Parameters(10).Value = (CStr(Category))
			End If
			If (Description Is Nothing) Then
				Me.Adapter.InsertCommand.Parameters(11).Value = Global.System.DBNull.Value
			Else
				Me.Adapter.InsertCommand.Parameters(11).Value = (CStr(Description))
			End If
			If (Hyperlink Is Nothing) Then
				Me.Adapter.InsertCommand.Parameters(12).Value = Global.System.DBNull.Value
			Else
				Me.Adapter.InsertCommand.Parameters(12).Value = (CStr(Hyperlink))
			End If
			...
			If (Price.HasValue = True) Then
				Me.Adapter.InsertCommand.Parameters(14).Value = (CDec(Price.Value))
			Else
			...
			Else
				Me.Adapter.InsertCommand.Parameters(15).Value = (CStr(RtfContent))
			End If
			If (Color.HasValue = True) Then
				Me.Adapter.InsertCommand.Parameters(16).Value = (CInt(Fix(Color.Value)))
			Else
		...
		Public Overridable Function Update(ByVal ResourceNumber As Global.System.Nullable(Of Integer), ByVal Trademark As String, ByVal Model As String, ByVal HP As Global.System.Nullable(Of Short), ByVal Liter As Global.System.Nullable(Of Double), ByVal Cyl As Global.System.Nullable(Of Byte), ByVal TransmissSpeedCount As Global.System.Nullable(Of Byte), ByVal TransmissAutomatic As String, ByVal MPG_City As Global.System.Nullable(Of Byte), ByVal MPG_Highway As Global.System.Nullable(Of Byte), ByVal Category As String, ByVal Description As String, ByVal Hyperlink As String, ByVal Picture() As Byte, ByVal Price As Global.System.Nullable(Of Decimal), ByVal RtfContent As String, ByVal Color As Global.System.Nullable(Of Integer), ByVal Original_ResourceNumber As Global.System.Nullable(Of Integer), ByVal Original_ID As Integer, ByVal Original_Trademark As String, ByVal Original_Model As String, ByVal Original_HP As Global.System.Nullable(Of Short), ByVal Original_Liter As Global.System.Nullable(Of Double), ByVal Original_Cyl As Global.System.Nullable(Of Byte), ByVal Original_TransmissSpeedCount As Global.System.Nullable(Of Byte), ByVal Original_TransmissAutomatic As String, ByVal Original_MPG_City As Global.System.Nullable(Of Byte), ByVal Original_MPG_Highway As Global.System.Nullable(Of Byte), ByVal Original_Category As String, ByVal Original_Hyperlink As String, ByVal Original_Price As Global.System.Nullable(Of Decimal), ByVal Original_Color As Global.System.Nullable(Of Integer)) As Integer
			If (ResourceNumber.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(0).Value = (CInt(Fix(ResourceNumber.Value)))
			Else
			...
			Else
				Me.Adapter.UpdateCommand.Parameters(1).Value = (CStr(Trademark))
			End If
			If (Model Is Nothing) Then
				Me.Adapter.UpdateCommand.Parameters(2).Value = Global.System.DBNull.Value
			Else
				Me.Adapter.UpdateCommand.Parameters(2).Value = (CStr(Model))
			End If
			If (HP.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(3).Value = (CShort(Fix(HP.Value)))
			Else
				Me.Adapter.UpdateCommand.Parameters(3).Value = Global.System.DBNull.Value
			End If
			If (Liter.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(4).Value = (CDbl(Liter.Value))
			Else
				Me.Adapter.UpdateCommand.Parameters(4).Value = Global.System.DBNull.Value
			End If
			If (Cyl.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(5).Value = (CByte(Cyl.Value))
			Else
				Me.Adapter.UpdateCommand.Parameters(5).Value = Global.System.DBNull.Value
			End If
			If (TransmissSpeedCount.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(6).Value = (CByte(TransmissSpeedCount.Value))
			Else
			...
			Else
				Me.Adapter.UpdateCommand.Parameters(7).Value = (CStr(TransmissAutomatic))
			End If
			If (MPG_City.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(8).Value = (CByte(MPG_City.Value))
			Else
				Me.Adapter.UpdateCommand.Parameters(8).Value = Global.System.DBNull.Value
			End If
			If (MPG_Highway.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(9).Value = (CByte(MPG_Highway.Value))
			Else
			...
			Else
				Me.Adapter.UpdateCommand.Parameters(10).Value = (CStr(Category))
			End If
			If (Description Is Nothing) Then
				Me.Adapter.UpdateCommand.Parameters(11).Value = Global.System.DBNull.Value
			Else
				Me.Adapter.UpdateCommand.Parameters(11).Value = (CStr(Description))
			End If
			If (Hyperlink Is Nothing) Then
				Me.Adapter.UpdateCommand.Parameters(12).Value = Global.System.DBNull.Value
			Else
				Me.Adapter.UpdateCommand.Parameters(12).Value = (CStr(Hyperlink))
			End If
			If (Picture Is Nothing) Then
			...
			End If
			If (Price.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(14).Value = (CDec(Price.Value))
			Else
			...
			Else
				Me.Adapter.UpdateCommand.Parameters(15).Value = (CStr(RtfContent))
			End If
			If (Color.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(16).Value = (CInt(Fix(Color.Value)))
			Else
				Me.Adapter.UpdateCommand.Parameters(16).Value = Global.System.DBNull.Value
			End If
			If (Original_ResourceNumber.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(17).Value = (CObj(0))
				Me.Adapter.UpdateCommand.Parameters(18).Value = (CInt(Fix(Original_ResourceNumber.Value)))
			Else
				Me.Adapter.UpdateCommand.Parameters(17).Value = (CObj(1))
				Me.Adapter.UpdateCommand.Parameters(18).Value = Global.System.DBNull.Value
			End If
			Me.Adapter.UpdateCommand.Parameters(19).Value = (CInt(Fix(Original_ID)))
			If (Original_Trademark Is Nothing) Then
				Me.Adapter.UpdateCommand.Parameters(20).Value = (CObj(1))
				Me.Adapter.UpdateCommand.Parameters(21).Value = Global.System.DBNull.Value
			Else
				Me.Adapter.UpdateCommand.Parameters(20).Value = (CObj(0))
				Me.Adapter.UpdateCommand.Parameters(21).Value = (CStr(Original_Trademark))
			End If
			If (Original_Model Is Nothing) Then
			...
			Else
				...
				Me.Adapter.UpdateCommand.Parameters(23).Value = (CStr(Original_Model))
			End If
			If (Original_HP.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(24).Value = (CObj(0))
				Me.Adapter.UpdateCommand.Parameters(25).Value = (CShort(Fix(Original_HP.Value)))
			Else
			...
			If (Original_Liter.HasValue = True) Then
				...
				Me.Adapter.UpdateCommand.Parameters(27).Value = (CDbl(Original_Liter.Value))
			Else
			...
			If (Original_Cyl.HasValue = True) Then
				...
				Me.Adapter.UpdateCommand.Parameters(29).Value = (CByte(Original_Cyl.Value))
			Else
			...
			If (Original_TransmissSpeedCount.HasValue = True) Then
				...
				Me.Adapter.UpdateCommand.Parameters(31).Value = (CByte(Original_TransmissSpeedCount.Value))
			Else
			...
			Else
				...
				Me.Adapter.UpdateCommand.Parameters(33).Value = (CStr(Original_TransmissAutomatic))
			End If
			If (Original_MPG_City.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(34).Value = (CObj(0))
				Me.Adapter.UpdateCommand.Parameters(35).Value = (CByte(Original_MPG_City.Value))
			Else
			...
			If (Original_MPG_Highway.HasValue = True) Then
				...
				Me.Adapter.UpdateCommand.Parameters(37).Value = (CByte(Original_MPG_Highway.Value))
			Else
			...
			Else
				...
				Me.Adapter.UpdateCommand.Parameters(39).Value = (CStr(Original_Category))
			End If
			If (Original_Hyperlink Is Nothing) Then
			...
			Else
				...
				Me.Adapter.UpdateCommand.Parameters(41).Value = (CStr(Original_Hyperlink))
			End If
			If (Original_Price.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(42).Value = (CObj(0))
				Me.Adapter.UpdateCommand.Parameters(43).Value = (CDec(Original_Price.Value))
			Else
				Me.Adapter.UpdateCommand.Parameters(42).Value = (CObj(1))
				Me.Adapter.UpdateCommand.Parameters(43).Value = Global.System.DBNull.Value
			End If
			If (Original_Color.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(44).Value = (CObj(0))
				Me.Adapter.UpdateCommand.Parameters(45).Value = (CInt(Fix(Original_Color.Value)))
			Else
				Me.Adapter.UpdateCommand.Parameters(44).Value = (CObj(1))
	...
	Partial Public Class CarSchedulingTableAdapter
		...
		<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"), Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, True)> _
		Public Overridable Function Fill(ByVal dataTable As CarsDBLabelDataSet.CarSchedulingDataTable) As Integer
			Me.Adapter.SelectCommand = Me.CommandCollection(0)
			If (Me.ClearBeforeFill = True) Then
				dataTable.Clear()
			End If
		...
		<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"), Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Select, True)> _
		Public Overridable Function GetData() As CarsDBLabelDataSet.CarSchedulingDataTable
			Me.Adapter.SelectCommand = Me.CommandCollection(0)
			Dim dataTable As New CarsDBLabelDataSet.CarSchedulingDataTable()
			Me.Adapter.Fill(dataTable)
			Return dataTable
		End Function

		<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")> _
		Public Overridable Function Update(ByVal dataTable As CarsDBLabelDataSet.CarSchedulingDataTable) As Integer
			Return Me.Adapter.Update(dataTable)
		End Function
