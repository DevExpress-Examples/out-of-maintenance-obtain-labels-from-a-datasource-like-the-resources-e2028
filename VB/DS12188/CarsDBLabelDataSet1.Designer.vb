...
Namespace DS12188.CarsDBLabelDataSet1TableAdapters
	...
	Partial Public Class LabelsTableAdapter
		...
		Public Overridable Function Delete(ByVal Original_Id As Integer, ByVal Original_Color? As Integer, ByVal Original_DisplayName As String, ByVal Original_MenuCaption As String) As Integer
		...
		Public Overridable Function Insert(ByVal Color? As Integer, ByVal DisplayName As String, ByVal MenuCaption As String) As Integer
		...
		Public Overridable Function Update(ByVal Color? As Integer, ByVal DisplayName As String, ByVal MenuCaption As String, ByVal Original_Id As Integer, ByVal Original_Color? As Integer, ByVal Original_DisplayName As String, ByVal Original_MenuCaption As String) As Integer
			If (Color.HasValue = True) Then
