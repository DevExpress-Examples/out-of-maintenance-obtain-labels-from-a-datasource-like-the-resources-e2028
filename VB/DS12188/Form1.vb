	...
	Partial Public Class Form1
		...
		Private Sub InitializeLabels()
			...
			For i As Integer = 0 To labels.Rows.Count - 1
				...
				Dim displayName As String = labels.Rows(i).ItemArray(2).ToString()
				Dim menuCaption As String = labels.Rows(i).ItemArray(3).ToString()
				Dim aptLabel As AppointmentLabel = schedulerControl1.Storage.Appointments.Labels.CreateNewLabel(labels.Rows(i).ItemArray(0), displayName, menuCaption, color)
